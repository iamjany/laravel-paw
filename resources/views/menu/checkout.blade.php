			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="billing checkout_section">
						<div class="section_title">Data Pembelian</div>
						<div class="section_subtitle">Masukan Data Pembelian</div>
						<div class="checkout_form_container">
							<form action="#" id="checkout_form" class="checkout_form">
								...
								<div>
									<!-- Zipcode -->
									<label for="checkout_zipcode">Kode Pembelian*</label>
								...
								<div>
									...
									<div class="button order_button"><a href="#">BELI</div>
								</div>
								<div>
									<!-- Email -->
				...
				<div class="col-lg-6">
					<div class="order checkout_section">
						<div class="section_title">Pembelian Anda</div>
						...
						<div class="order_list_container">
							<div class="order_list_bar d-flex flex-row align-items-center justify-content-start">
								...
								<div class="order_list_value ml-auto">Liter</div>
							</div>
							<ul class="order_list">
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div class="order_list_title">Bensin yang dibeli</div>
									<div class="order_list_value ml-auto">Rp.7.500</div>
								</li>
